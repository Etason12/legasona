    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6 flex flex-col h-[400px]">
          ...
          <button onClick={() => navigate('/activity')} className="w-full mt-4 py-3 border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-md text-sm font-medium text-slate-500 dark:text-slate-400 transition-colors">
            {t('viewAllActivity')}
          </button>
        </div>
      </div>
