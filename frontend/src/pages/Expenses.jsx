    ...
    <div className="p-6 border-b border-slate-200 dark:border-slate-700 flex flex-col md:flex-row md:items-center justify-between gap-4">
     ...
     <div className="hidden md:block overflow-x-auto custom-scrollbar">
      <table className="w-full text-left">
       <thead>
        <tr className="bg-white dark:bg-slate-800 border-b border-slate-300 dark:border-slate-700 text-xs font-bold text-slate-500 ">
         ...
         <tr>
          ...
          <tr key={expense.id} className="hover:bg-slate-100 dark:bg-slate-800/50 transition-colors group">
           ...
           <td className="px-6 py-4">
            <span className="px-2.5 py-1 rounded-lg text-xs font-bold bg-slate-800 text-slate-400 border border-slate-200 dark:border-slate-700 uppercase tracking-wider">
